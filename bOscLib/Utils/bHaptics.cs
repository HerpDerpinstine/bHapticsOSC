...
namespace bHapticsOSC.Utils
{
    public static class bHaptics
    {
        ...
        private static HapticPlayerManager hapticPlayerManager;
        ...
        public static void Load()
        {
            ...
            HapticPlayerManager.SetAppInfo(BuildInfo.Name, BuildInfo.Name);
            hapticPlayerManager = HapticPlayerManager.Instance();
            hapticPlayer = hapticPlayerManager.GetHapticPlayer();
        }
        ...
        //public static void Quit() => hapticPlayer?.TurnOff();
